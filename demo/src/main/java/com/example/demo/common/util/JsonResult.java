...
public class JsonResult implements Serializable {
	...
	public static final JsonResult success(Object data) {
		return new JsonResult(StatusCode.CODE_SUCCESS, "操作成功", data);
	}
	...
	public static final JsonResult success() {
		return new JsonResult(StatusCode.CODE_SUCCESS, "操作成功", NOOP);
	}
	...
	public static final JsonResult success(String message) {
		return new JsonResult(StatusCode.CODE_SUCCESS, message, NOOP);
	}
	...
	public static final JsonResult success(String message, Object data) {
		return new JsonResult(StatusCode.CODE_SUCCESS, message, data);
	}
	 ...
	 * @return data
	 */
	public static final JsonResult failure(Integer code, String message) {
	...
	public static final JsonResult failure(String message) {
		return failure(StatusCode.CODE_FAILURED, message);
	}
